...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar atleta");
	...
	/**
	 * Le pide al usuario el nombre de un atleta el cual
	 * se quiere saber el pais que representa
	 */
	private void ejecutarAtletaPais() {
		System.out.println("\n" + "Atleta de un país" + "\n");

		String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
		var atletas = calculadora.paisAtleta(nombreAtleta);
		if (atletas == null) {
			System.out.println("No existe un atleta con ese nombre");
		} else {
			System.out.println("El atleta "+ nombreAtleta + " representa el pais de: "+  atletas);
		}
