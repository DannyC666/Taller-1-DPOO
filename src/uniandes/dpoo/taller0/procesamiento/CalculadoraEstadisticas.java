...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais que representa el atleta deseado
	 *
	 * @param nombreAtleta El nombre del atleta que se está buscando
	 * @return El pais que representa el atleta, o null si no lo encuentra.
	 */
	public String paisAtleta (String nombreAtleta){

		String resultado =  (String)null;
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		if (elAtleta == null){
			...
			for (Atleta atleta : atletas){
				...
				var compare = elAtleta.equals(atleta);
